...
export default class MovieList extends React.Component {
    ...
    getMovies = async() => {
        try{
            const data = await fetch("https://crudcrud.com/api/c796f522f0a848c58597f314e8dcd759/movies")
    ...
    async submitMovies(newMovie, e) {
        try{
            ...
            await fetch("https://crudcrud.com/api/c796f522f0a848c58597f314e8dcd759/movies", {
                method: "POST",
                headers: {
